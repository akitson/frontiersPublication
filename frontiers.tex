...
%In the following study we want to replicate the influence of parameters already in the model as well as adding new facets.
...
\end{tabular}
%\caption{model parameters of the multinomial regression models}  
\label{tab:LRT}
\end{table}
...
%\end{flushleft}
%\label{tab:paramValues}
%\caption{Parameter values of the multinomial regression model for all parameters and each respective outcome compared to the strategy baseline no preference}
%\end{table}
