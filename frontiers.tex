...
\def\firstAuthorLast{Sproll {et~al.}} %use et al only if is more than 1 author
...
\def\Address{$^{1}$Institute of Cognitive Science, University of Osnabr\"uck, Germany \\
$^{2}$School of Interactive Arts + Technology, Simon Fraser University, Surrey, BC, Canada}
% The Corresponding Author should be marked with an asterisk
% Provide the exact contact address (this time including street name and city zip code) and email of the corresponding author
\def\corrAuthor{corresponding Author}
\def\corrAddress{Daniel Sproll, Institute of Cognitive Science, University of Osnabr\"uck, Germany.}
\def\corrEmail{dsproll@uos.de}
...
In a virtual point-to-origin task, participants seem to use different strategies for orientation. This study aims to investigate the turner and non-turner orientation strategy phenomenon with three specific goals in mind: first, extend previous findings of higher turner numbers with spatial language response mode, opposed to pointing response mode; second, replicate the gender effect of males more likely as turners; third, examine ethnicity influence. Designed as a classroom study, we presented participants (n=498) with four passages through a virtual star field. Participants selected the direction pointing to the origin from four multiple-choice items. The two different response modes were pictograms and written language. Finally, participants filled out a demographics questionnaire. Results show a majority of participants ($44.78\%$) classified as non-turners, $25.3\%$ turners, and $18.88\%$ with no preference. A multinomial regression model reached $49\%$ classification performance, and two main factors (Ethnicity and Condition) and two interaction terms (Ethnicity: Condition and Condition: Gender) were significant. Written spatial language, compared to pictograms, made the turner strategy more likely, was more pronounced for Chinese participants and among females, and was not significant for male Caucasians. We extended findings showing higher numbers of turners using spatial language instead of pointing. Pointing (pictorial condition) may have additional cognitive load because it is an embodied response, though it remains to be seen where it takes place and how we can mitigate it. Second, our results are inconsistent with previous research, which found a gender difference in navigation strategy. Future research may look at possible underlying factors, such as cultural norms. Third, egocentric based cultures (Caucasians) seem to employ an egocentric strategy when navigating in virtual environments. Likewise, allocentric based cultures seem to use an allocentric strategy.
